        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateLostOrFound = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_ItemId_ClaimantId",
                table: "Claims",
                columns: new[] { "ItemId", "ClaimantId" },
                unique: true,
                filter: "[Status] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_Type_Status_CategoryId",
                table: "Items",
                columns: new[] { "Type", "Status", "CategoryId" });
